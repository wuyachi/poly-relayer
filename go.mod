...
require (
	...
	github.com/polynetwork/bridge-common v0.0.24-ok
...
replace (
	...
	github.com/polynetwork/bridge-common => github.com/wuyachi/bridge-common v0.0.0-20220518165822-0901d66d56d6
)
